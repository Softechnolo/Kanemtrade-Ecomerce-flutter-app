...
class AppConfig {
  static String copyright_text = "@ Sofset Technologies " + this_year; //this shows in the splash screen
  static String app_name = "Kanemtrade"; //this shows in the splash screen
  static String purchase_code = "z"; //enter your purchase code for the app from codecanyon
  ...
  //configure this
  static const DOMAIN_PATH = "kanemtrade.com"; //localhost
